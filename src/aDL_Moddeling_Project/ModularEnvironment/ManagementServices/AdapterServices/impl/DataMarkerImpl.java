...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Data Marker</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link aDL_Moddeling_Project.ModularEnvironment.ManagementServices.AdapterServices.impl.DataMarkerImpl#getSemantics <em>Semantics</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DataMarkerImpl extends EntityImpl implements DataMarker {
	/**
	...
	protected EClass eStaticClass() {
		return AdapterServicesPackage.Literals.DATA_MARKER;
	}
	...
	public void setSemantics(String newSemantics) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AdapterServicesPackage.DATA_MARKER__SEMANTICS, oldSemantics, semantics));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AdapterServicesPackage.DATA_MARKER__SEMANTICS:
				return getSemantics();
		}
