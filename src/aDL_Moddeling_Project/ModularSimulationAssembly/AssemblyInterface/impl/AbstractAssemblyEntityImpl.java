...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Abstract Assembly Entity</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link aDL_Moddeling_Project.ModularSimulationAssembly.AssemblyInterface.impl.AbstractAssemblyEntityImpl#getSemantics <em>Semantics</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class AbstractAssemblyEntityImpl extends EntityImpl implements AbstractAssemblyEntity {
	/**
	 ...
	 * @generated
	 */
	protected AbstractAssemblyEntityImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return AssemblyInterfacePackage.Literals.ABSTRACT_ASSEMBLY_ENTITY;
	}
	...
	public void setSemantics(String newSemantics) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AssemblyInterfacePackage.ABSTRACT_ASSEMBLY_ENTITY__SEMANTICS, oldSemantics, semantics));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AssemblyInterfacePackage.ABSTRACT_ASSEMBLY_ENTITY__SEMANTICS:
				return getSemantics();
		}
