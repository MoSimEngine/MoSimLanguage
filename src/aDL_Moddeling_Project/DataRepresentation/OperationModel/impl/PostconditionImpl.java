 ...
 * </p>
 * <ul>
 *   <li>{@link aDL_Moddeling_Project.DataRepresentation.OperationModel.impl.PostconditionImpl#getDescription <em>Description</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PostconditionImpl extends MinimalEObjectImpl.Container implements Postcondition {
	...
	protected EClass eStaticClass() {
		return OperationModelPackage.Literals.POSTCONDITION;
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OperationModelPackage.POSTCONDITION__DESCRIPTION, oldDescription, description));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OperationModelPackage.POSTCONDITION__DESCRIPTION:
