...
import aDL_Moddeling_Project.DataRepresentation.OperationModel.OperationModelFactory;
 ...
 * @generated
 */
public class OperationModelPackageImpl extends EPackageImpl implements OperationModelPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @generated
	 */
	private EClass operationExecutionEffectEClass = null;
	 ...
	 * @generated
	 */
	private EClass executionEffectOnDataEClass = null;
	 ...
	 * @generated
	 */
	private EClass operationParameterDefinitionEClass = null;
	 ...
	 * @see aDL_Moddeling_Project.DataRepresentation.OperationModel.OperationModelPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private OperationModelPackageImpl() {
		super(eNS_URI, OperationModelFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link OperationModelPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static OperationModelPackage init() {
		if (isInited) return (OperationModelPackage)EPackage.Registry.INSTANCE.getEPackage(OperationModelPackage.eNS_URI);

		// Obtain or create and register package
		OperationModelPackageImpl theOperationModelPackage = (OperationModelPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof OperationModelPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new OperationModelPackageImpl());
		...
		theOperationModelPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(OperationModelPackage.eNS_URI, theOperationModelPackage);
		return theOperationModelPackage;
	}
	 ...
	 * @generated
	 */
	public EReference getOperation_Operationexecutioneffect() {
	 ...
	 * @generated
	 */
	public EClass getoperationExecutionEffect() {
		return operationExecutionEffectEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getoperationExecutionEffect_Executioneffectondata() {
		return (EReference)operationExecutionEffectEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EClass getexecutionEffectOnData() {
		return executionEffectOnDataEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getexecutionEffectOnData_Effect() {
		return (EAttribute)executionEffectOnDataEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getexecutionEffectOnData_Data() {
		return (EReference)executionEffectOnDataEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EClass getOperationParameterDefinition() {
		return operationParameterDefinitionEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getOperationParameterDefinition_IdentifiingName() {
		return (EAttribute)operationParameterDefinitionEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getOperationParameterDefinition_Optional() {
		return (EAttribute)operationParameterDefinitionEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getOperationParameterDefinition_DataType() {
		return (EReference)operationParameterDefinitionEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EAttribute getPrecondition_Description() {
	 ...
	 * @generated
	 */
	public EAttribute getPostcondition_Description() {
	 ...
	 * @generated
	 */
	public OperationModelFactory getOperationModelFactory() {
		return (OperationModelFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEReference(operationEClass, OPERATION__OPERATIONEXECUTIONEFFECT);
		createEReference(operationEClass, OPERATION__POSTCONDITION);
		createEReference(operationEClass, OPERATION__RETURN_TYPE);

		operationExecutionEffectEClass = createEClass(OPERATION_EXECUTION_EFFECT);
		createEReference(operationExecutionEffectEClass, OPERATION_EXECUTION_EFFECT__EXECUTIONEFFECTONDATA);

		executionEffectOnDataEClass = createEClass(EXECUTION_EFFECT_ON_DATA);
		createEAttribute(executionEffectOnDataEClass, EXECUTION_EFFECT_ON_DATA__EFFECT);
		createEReference(executionEffectOnDataEClass, EXECUTION_EFFECT_ON_DATA__DATA);

		operationParameterDefinitionEClass = createEClass(OPERATION_PARAMETER_DEFINITION);
		createEAttribute(operationParameterDefinitionEClass, OPERATION_PARAMETER_DEFINITION__IDENTIFIING_NAME);
		createEAttribute(operationParameterDefinitionEClass, OPERATION_PARAMETER_DEFINITION__OPTIONAL);
		createEReference(operationParameterDefinitionEClass, OPERATION_PARAMETER_DEFINITION__DATA_TYPE);

		preconditionEClass = createEClass(PRECONDITION);
		createEAttribute(preconditionEClass, PRECONDITION__DESCRIPTION);

		postconditionEClass = createEClass(POSTCONDITION);
		createEAttribute(postconditionEClass, POSTCONDITION__DESCRIPTION);
	}
	...
	public void initializePackageContents() {
		...
		operationEClass.getESuperTypes().add(theBasicPackage.getEntity());
		operationEClass.getESuperTypes().add(theAdapterServicesPackage.getAdaptable());

		// Initialize classes, features, and operations; add parameters
		initEClass(operationEClass, Operation.class, "Operation", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getOperation_Precondition(), this.getPrecondition(), null, "precondition", null, 0, -1, Operation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getOperation_Parameters(), this.getOperationParameterDefinition(), null, "parameters", null, 0, -1, Operation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getOperation_Operationexecutioneffect(), this.getoperationExecutionEffect(), null, "operationexecutioneffect", null, 0, 1, Operation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getOperation_Postcondition(), this.getPostcondition(), null, "postcondition", null, 0, -1, Operation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getOperation_ReturnType(), theDataTypesPackage.getDataTypeSpecification(), null, "returnType", null, 0, 1, Operation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(operationExecutionEffectEClass, operationExecutionEffect.class, "operationExecutionEffect", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getoperationExecutionEffect_Executioneffectondata(), this.getexecutionEffectOnData(), null, "executioneffectondata", null, 0, -1, operationExecutionEffect.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(executionEffectOnDataEClass, executionEffectOnData.class, "executionEffectOnData", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getexecutionEffectOnData_Effect(), ecorePackage.getEString(), "effect", null, 0, 1, executionEffectOnData.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getexecutionEffectOnData_Data(), theDataSpecificationPackage.getData(), null, "data", null, 1, 1, executionEffectOnData.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(operationParameterDefinitionEClass, OperationParameterDefinition.class, "OperationParameterDefinition", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getOperationParameterDefinition_IdentifiingName(), ecorePackage.getEString(), "identifiingName", null, 1, 1, OperationParameterDefinition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getOperationParameterDefinition_Optional(), ecorePackage.getEBoolean(), "optional", null, 1, 1, OperationParameterDefinition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getOperationParameterDefinition_DataType(), theDataTypesPackage.getDataTypeSpecification(), null, "dataType", null, 1, 1, OperationParameterDefinition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(preconditionEClass, Precondition.class, "Precondition", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getPrecondition_Description(), ecorePackage.getEString(), "description", null, 1, 1, Precondition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(postconditionEClass, Postcondition.class, "Postcondition", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getPostcondition_Description(), ecorePackage.getEString(), "description", null, 1, 1, Postcondition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	}

} //OperationModelPackageImpl
