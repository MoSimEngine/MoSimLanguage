...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Basic Typed Data</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link aDL_Moddeling_Project.DataRepresentation.DataSpecification.impl.BasicTypedDataImpl#getBasedatatype <em>Basedatatype</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BasicTypedDataImpl extends GeneralTypedDataImpl implements BasicTypedData {
	/**
	...
	protected EClass eStaticClass() {
		return DataSpecificationPackage.Literals.BASIC_TYPED_DATA;
	}
		...
		if (basedatatype != null && basedatatype.eIsProxy()) {
			...
			if (basedatatype != oldBasedatatype) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DataSpecificationPackage.BASIC_TYPED_DATA__BASEDATATYPE, oldBasedatatype, basedatatype));
			}
		}
		return basedatatype;
	}
	...
	public void setBasedatatype(BaseDataType newBasedatatype) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DataSpecificationPackage.BASIC_TYPED_DATA__BASEDATATYPE, oldBasedatatype, basedatatype));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DataSpecificationPackage.BASIC_TYPED_DATA__BASEDATATYPE:
